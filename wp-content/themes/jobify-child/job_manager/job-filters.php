	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			...
			<!--<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Keywords', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" />-->
                        <?php include get_stylesheet_directory().'/includes/indeed-valid-keywords.php'; ?>
                        <select name="search_keywords" id="search_keywords">
                            <?php foreach ($valid_keywords as $val => $keyword) { 
                                $selected='';
                                if($keywords == $keyword){
                                    $selected = 'selected="selected"';
                                }
                                ?>
                            <option <?= $selected; ?> value="<?= $val; ?>"><?= $keyword; ?></option>
                            <?php } ?>
                        </select>
		</div>
