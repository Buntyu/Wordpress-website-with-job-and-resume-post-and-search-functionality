	...
	public function form() {
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input type="hidden" class="wc-customer-search" id="user_id" name="user_id" data-placeholder="<?php _e( 'Guest', 'woocommerce' ); ?>" data-selected="<?php echo esc_attr( $user_string ); ?>" value="<?php echo esc_attr( $user_id ); ?>" data-allow_clear="true" style="width:25em" />
				</td>
			</tr>
			<tr>
				<th>
